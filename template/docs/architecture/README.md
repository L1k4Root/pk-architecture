...
Structured with [arc42](https://arc42.org), diagrams follow the [C4 model](https://c4model.com)
and are written in Mermaid so they are versioned and reviewed like code.
